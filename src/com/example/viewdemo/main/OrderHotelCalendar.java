package com.example.viewdemo.main;
...
import com.example.viewdemo.view.MyCalendar;
import com.example.viewdemo.view.MyCalendar.OnDaySelectListener;

public class OrderHotelCalendar extends Activity implements OnDaySelectListener {
	LinearLayout ll;
	MyCalendar c1;
	Date date;
	String nowday;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.orderhotel_calendar);
			...
			if (inday.equals(date)) {
				...
				try {
					if (simpleDateFormat.parse(date).getTime() < simpleDateFormat
						...
						view.setBackgroundColor(Color.WHITE);
						textDayView.setTextColor(Color.BLACK);
						Toast.makeText(OrderHotelCalendar.this, "离开日期不能小于入住日期",
