...
import com.example.trip.share.CustomShareBoard;
...
public class ShareManager {
	...
	private void setShareContent() {
		...
		UMImage localImage = new UMImage(activity, R.drawable.logs);
		...
		UMImage image = new UMImage(activity, BitmapFactory.decodeResource(
				activity.getResources(), R.drawable.logs));
		image.setTitle("走知");
